package com.example.creditcard.desingcard.livedata
...
class CreditCardViewModel:ViewModel() {
    ...
    val carNumber: LiveData<String> = _cardNumber

    private var _cardHolder = MutableLiveData<String>()
    val carHolder: LiveData<String> = _cardHolder

    private var _cardExpiration = MutableLiveData<String>()
    val carExpiration: LiveData<String> = _cardExpiration
